/*
 ...
 Source Schema         : springbootau72407e

 Target Server Type    : MySQL
 Target Server Version : 80041 (8.0.41)
 File Encoding         : 65001

 Date: 29/03/2026 16:34:28
*/
...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '地址' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of address
-- ----------------------------
INSERT INTO `address` VALUES (1, '2024-03-25 13:38:01', 11, '宇宙银河系金星1号', '金某', '13823888881', '是');
INSERT INTO `address` VALUES (2, '2024-03-25 13:38:01', 12, '宇宙银河系木星1号', '木某', '13823888882', '是');
INSERT INTO `address` VALUES (3, '2024-03-25 13:38:01', 13, '宇宙银河系水星1号', '水某', '13823888883', '是');
INSERT INTO `address` VALUES (4, '2024-03-25 13:38:01', 14, '宇宙银河系火星1号', '火某', '13823888884', '是');
INSERT INTO `address` VALUES (5, '2024-03-25 13:38:01', 15, '宇宙银河系土星1号', '土某', '13823888885', '是');
INSERT INTO `address` VALUES (6, '2024-03-25 13:38:01', 16, '宇宙银河系月球1号', '月某', '13823888886', '是');
INSERT INTO `address` VALUES (7, '2024-03-25 13:38:01', 17, '宇宙银河系黑洞1号', '黑某', '13823888887', '是');
INSERT INTO `address` VALUES (8, '2024-03-25 13:38:01', 18, '宇宙银河系地球1号', '地某', '13823888888', '是');
INSERT INTO `address` VALUES (9, '2024-03-25 18:45:17', 1711357906369, '广东省深圳市', '123', '13888888888', '是');
...
CREATE TABLE `cart`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `tablename` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT 'shangpinxinxi' COMMENT '汽车表名',
  `userid` bigint NOT NULL COMMENT '用户id',
  ...
  `shangjiahao` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '商户名称',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '购物车表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of cart
-- ----------------------------
INSERT INTO `cart` VALUES (1, '2024-03-25 18:09:51', 'shangpinxinxi', 1711357906369, 58, '汽车1', 'upload/1711358662518.jpeg', 1, 3333, '商家号6');
INSERT INTO `cart` VALUES (2, '2024-03-25 18:09:55', 'shangpinxinxi', 1711357906369, 57, '汽车2', 'upload/1711358650564.jpeg', 1, 33333, '商家号6');
...
CREATE TABLE `chat`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 63 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '在线客服' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of chat
-- ----------------------------
INSERT INTO `chat` VALUES (51, '2024-03-25 13:38:01', 1, 1, '提问1', '回复1', 0);
INSERT INTO `chat` VALUES (52, '2024-03-25 13:38:01', 2, 2, '提问2', '回复2', 2);
INSERT INTO `chat` VALUES (53, '2024-03-25 13:38:01', 3, 3, '提问3', '回复3', 3);
INSERT INTO `chat` VALUES (54, '2024-03-25 13:38:01', 4, 4, '提问4', '回复4', 4);
INSERT INTO `chat` VALUES (55, '2024-03-25 13:38:01', 5, 5, '提问5', '回复5', 5);
INSERT INTO `chat` VALUES (56, '2024-03-25 13:38:01', 6, 6, '提问6', '回复6', 6);
INSERT INTO `chat` VALUES (57, '2024-03-25 13:38:01', 7, 7, '提问7', '回复7', 7);
INSERT INTO `chat` VALUES (58, '2024-03-25 13:38:01', 8, 8, '提问8', '回复8', 8);
INSERT INTO `chat` VALUES (59, '2024-03-25 18:44:08', 1711357906369, NULL, 'nihao', NULL, 0);
INSERT INTO `chat` VALUES (60, '2024-03-25 18:47:26', 1711357906369, NULL, '111', NULL, 0);
INSERT INTO `chat` VALUES (61, '2024-03-25 18:48:32', 1, 1, NULL, '1', NULL);
INSERT INTO `chat` VALUES (62, '2024-03-25 18:48:40', 1711357906369, 1, NULL, '1', NULL);
...
-- Records of config
-- ----------------------------
INSERT INTO `config` VALUES (1, 'picture1', 'upload/1711359092685.jpeg', NULL);
INSERT INTO `config` VALUES (2, 'picture2', 'upload/1711359085002.jpeg', NULL);
INSERT INTO `config` VALUES (3, 'picture3', 'upload/1711359074379.jpeg', NULL);
...
CREATE TABLE `discussshangpinxinxi`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '汽车信息评论表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of discussshangpinxinxi
-- ----------------------------
INSERT INTO `discussshangpinxinxi` VALUES (1, '2024-03-25 18:47:46', 57, 1711357906369, 'upload/1711357916574.jpg', '123', '<p>dad</p>', NULL);
...
CREATE TABLE `forum`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 69 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '论坛表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of forum
-- ----------------------------
INSERT INTO `forum` VALUES (61, '2024-03-25 13:38:01', '帖子标题1', '帖子内容1', 0, 1, '用户名1', 'upload/forum_avatarurl1.jpg,upload/forum_avatarurl2.jpg,upload/forum_avatarurl3.jpg', '开放', 0, '2024-03-25 13:38:01');
INSERT INTO `forum` VALUES (62, '2024-03-25 13:38:01', '帖子标题2', '帖子内容2', 0, 2, '用户名2', 'upload/forum_avatarurl2.jpg,upload/forum_avatarurl3.jpg,upload/forum_avatarurl4.jpg', '开放', 0, '2024-03-25 13:38:01');
INSERT INTO `forum` VALUES (63, '2024-03-25 13:38:01', '帖子标题3', '帖子内容3', 0, 3, '用户名3', 'upload/forum_avatarurl3.jpg,upload/forum_avatarurl4.jpg,upload/forum_avatarurl5.jpg', '开放', 0, '2024-03-25 13:38:01');
INSERT INTO `forum` VALUES (64, '2024-03-25 13:38:01', '帖子标题4', '帖子内容4', 0, 4, '用户名4', 'upload/forum_avatarurl4.jpg,upload/forum_avatarurl5.jpg,upload/forum_avatarurl6.jpg', '开放', 0, '2024-03-25 13:38:01');
INSERT INTO `forum` VALUES (65, '2024-03-25 13:38:01', '帖子标题5', '帖子内容5', 0, 5, '用户名5', 'upload/forum_avatarurl5.jpg,upload/forum_avatarurl6.jpg,upload/forum_avatarurl7.jpg', '开放', 0, '2024-03-25 13:38:01');
INSERT INTO `forum` VALUES (66, '2024-03-25 13:38:01', '帖子标题6', '帖子内容6', 0, 6, '用户名6', 'upload/forum_avatarurl6.jpg,upload/forum_avatarurl7.jpg,upload/forum_avatarurl8.jpg', '开放', 0, '2024-03-25 13:38:01');
INSERT INTO `forum` VALUES (67, '2024-03-25 13:38:01', '帖子标题7', '帖子内容7', 0, 7, '用户名7', 'upload/forum_avatarurl7.jpg,upload/forum_avatarurl8.jpg,upload/forum_avatarurl9.jpg', '开放', 0, '2024-03-25 13:38:01');
INSERT INTO `forum` VALUES (68, '2024-03-25 13:38:01', '帖子标题8', '帖子内容8', 0, 8, '用户名8', 'upload/forum_avatarurl8.jpg,upload/forum_avatarurl9.jpg,upload/forum_avatarurl10.jpg', '开放', 0, '2024-03-25 13:38:01');
...
CREATE TABLE `newstype`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 109 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '公告信息分类' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of newstype
-- ----------------------------
INSERT INTO `newstype` VALUES (101, '2024-03-25 13:38:01', '分类名称1');
INSERT INTO `newstype` VALUES (102, '2024-03-25 13:38:01', '分类名称2');
INSERT INTO `newstype` VALUES (103, '2024-03-25 13:38:01', '分类名称3');
INSERT INTO `newstype` VALUES (104, '2024-03-25 13:38:01', '分类名称4');
INSERT INTO `newstype` VALUES (105, '2024-03-25 13:38:01', '分类名称5');
INSERT INTO `newstype` VALUES (106, '2024-03-25 13:38:01', '分类名称6');
INSERT INTO `newstype` VALUES (107, '2024-03-25 13:38:01', '分类名称7');
INSERT INTO `newstype` VALUES (108, '2024-03-25 13:38:01', '分类名称8');
...
-- Records of orders
-- ----------------------------
INSERT INTO `orders` VALUES (1, '2024-03-25 18:45:21', '2024325184521688', 'shangpinxinxi', 1711357906369, 58, '汽车1', 'upload/1711358662518.jpeg', 1, 3333, 3333, 1, '未支付', '广东省深圳市', '13888888888', '123', NULL, '', '商家号6', '', NULL, 'yonghu');
INSERT INTO `orders` VALUES (2, '2024-03-25 18:45:47', '2024325184547947', 'shangpinxinxi', 1711357906369, 57, '汽车2', 'upload/1711358650564.jpeg', 1, 33333, 33333, 1, '已完成', '广东省深圳市', '13888888888', '123', NULL, '', '商家号6', '', NULL, 'yonghu');
...
CREATE TABLE `shangjia`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `shangjiahao` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '商家号',
  ...
  `shangjiadizhi` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '商家地址',
  `lianxidianhua` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '联系电话',
  `shangjiayouxiang` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '商家邮箱',
  `yingyezhizhao` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '营业执照',
  `shangpuzhaopian` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '商铺照片',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `shangjiahao`(`shangjiahao` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 29 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '商家' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of shangjia
-- ----------------------------
INSERT INTO `shangjia` VALUES (21, '2024-03-25 13:38:01', '商家号1', '123456', '商家名称1', '商家地址1', '13823888881', '773890001@qq.com', '', 'upload/shangjia_shangpuzhaopian1.jpg', '商家介绍1', 200);
INSERT INTO `shangjia` VALUES (22, '2024-03-25 13:38:01', '商家号2', '123456', '商家名称2', '商家地址2', '13823888882', '773890002@qq.com', '', 'upload/shangjia_shangpuzhaopian2.jpg', '商家介绍2', 200);
INSERT INTO `shangjia` VALUES (23, '2024-03-25 13:38:01', '商家号3', '123456', '商家名称3', '商家地址3', '13823888883', '773890003@qq.com', '', 'upload/shangjia_shangpuzhaopian3.jpg', '商家介绍3', 200);
INSERT INTO `shangjia` VALUES (24, '2024-03-25 13:38:01', '商家号4', '123456', '商家名称4', '商家地址4', '13823888884', '773890004@qq.com', '', 'upload/shangjia_shangpuzhaopian4.jpg', '商家介绍4', 200);
INSERT INTO `shangjia` VALUES (25, '2024-03-25 13:38:01', '商家号5', '123456', '商家名称5', '商家地址5', '13823888885', '773890005@qq.com', '', 'upload/shangjia_shangpuzhaopian5.jpg', '商家介绍5', 200);
INSERT INTO `shangjia` VALUES (26, '2024-03-25 13:38:01', '商家号6', '123456', '商家名称6', '商家地址6', '13823888886', '773890006@qq.com', '', 'upload/shangjia_shangpuzhaopian6.jpg', '商家介绍6', 200);
INSERT INTO `shangjia` VALUES (27, '2024-03-25 13:38:01', '商家号7', '123456', '商家名称7', '商家地址7', '13823888887', '773890007@qq.com', '', 'upload/shangjia_shangpuzhaopian7.jpg', '商家介绍7', 200);
INSERT INTO `shangjia` VALUES (28, '2024-03-25 13:38:01', '商家号8', '123456', '商家名称8', '商家地址8', '13823888888', '773890008@qq.com', '', 'upload/shangjia_shangpuzhaopian8.jpg', '商家介绍8', 200);
...
CREATE TABLE `shangpinxinxi`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `shangpinmingcheng` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '汽车名称',
  `shangpinzhonglei` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '汽车种类',
  `shangpintupian` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '汽车图片',
  `shangpinxiangqing` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '汽车详情',
  `shangjiahao` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '商家号',
  ...
  `storeupnum` int NULL DEFAULT 0 COMMENT '收藏数',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 59 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '汽车信息' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of shangpinxinxi
-- ----------------------------
INSERT INTO `shangpinxinxi` VALUES (49, '2024-03-25 17:11:34', '汽车8', '类型8', 'upload/1711357890941.jpeg', '', '商家号8', '商家名称8', '13823888888', '商家地址8', 4, 0, 333333, 0);
INSERT INTO `shangpinxinxi` VALUES (50, '2024-03-25 17:12:56', '汽车9', '类型9', 'upload/1711357972340.jpeg', '', '商家号8', '商家名称8', '13823888888', '商家地址8', 0, 0, 111111, 0);
INSERT INTO `shangpinxinxi` VALUES (51, '2024-03-25 17:13:10', '汽车10', '类型10', 'upload/1711357986156.jpeg', '', '商家号8', '商家名称8', '13823888888', '商家地址8', 5, 0, 10000, 0);
INSERT INTO `shangpinxinxi` VALUES (52, '2024-03-25 17:13:44', '汽车7', '类型7', 'upload/1711358019547.jpg', '', '商家号7', '商家名称7', '13823888887', '商家地址7', 2, 0, 3000, 0);
INSERT INTO `shangpinxinxi` VALUES (53, '2024-03-25 17:13:57', '汽车6', '类型6', 'upload/1711358034163.jpg', '<p>3</p>', '商家号7', '商家名称7', '13823888887', '商家地址7', 7, 0, 33333, 0);
INSERT INTO `shangpinxinxi` VALUES (54, '2024-03-25 17:14:26', '汽车5', '类型5', 'upload/1711358063103.jpeg', '', '商家号7', '商家名称7', '13823888887', '商家地址7', 2, 0, 33333, 0);
INSERT INTO `shangpinxinxi` VALUES (55, '2024-03-25 17:15:29', '汽车4', '类型4', 'upload/1711358126157.jpeg', '', '商家号7', '商家名称7', '13823888887', '商家地址7', 0, 0, 1233, 0);
INSERT INTO `shangpinxinxi` VALUES (56, '2024-03-25 17:16:49', '汽车3', '类型3', 'upload/1711358206594.jpeg', '', '商家号6', '商家名称6', '13823888886', '商家地址6', 1, 0, 3333, 0);
INSERT INTO `shangpinxinxi` VALUES (57, '2024-03-25 17:24:14', '汽车2', '类型2', 'upload/1711358650564.jpeg', '', '商家号6', '商家名称6', '13823888886', '商家地址6', 5, 1, 33333, 1);
INSERT INTO `shangpinxinxi` VALUES (58, '2024-03-25 17:24:25', '汽车1', '类型1', 'upload/1711358662518.jpeg', '', '商家号6', '商家名称6', '13823888886', '商家地址6', 7, 0, 3333, 0);

-- ----------------------------
-- Table structure for shangpinzhonglei
-- ----------------------------
...
CREATE TABLE `shangpinzhonglei`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `shangpinzhonglei`(`shangpinzhonglei` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 49 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '汽车种类' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of shangpinzhonglei
-- ----------------------------
INSERT INTO `shangpinzhonglei` VALUES (39, '2024-03-25 17:09:50', '类型1', 'upload/1711357790058.jpeg');
INSERT INTO `shangpinzhonglei` VALUES (40, '2024-03-25 17:09:57', '类型2', 'upload/1711357796842.jpeg');
INSERT INTO `shangpinzhonglei` VALUES (41, '2024-03-25 17:10:04', '类型3', 'upload/1711357804007.jpeg');
INSERT INTO `shangpinzhonglei` VALUES (42, '2024-03-25 17:10:11', '类型4', 'upload/1711357811247.jpeg');
INSERT INTO `shangpinzhonglei` VALUES (43, '2024-03-25 17:10:19', '类型5', 'upload/1711357819023.jpeg');
INSERT INTO `shangpinzhonglei` VALUES (44, '2024-03-25 17:10:28', '类型6', 'upload/1711357827466.jpg');
INSERT INTO `shangpinzhonglei` VALUES (45, '2024-03-25 17:10:35', '类型7', 'upload/1711357834509.jpg');
INSERT INTO `shangpinzhonglei` VALUES (46, '2024-03-25 17:10:42', '类型8', 'upload/1711357841664.jpeg');
INSERT INTO `shangpinzhonglei` VALUES (47, '2024-03-25 17:10:52', '类型9', 'upload/1711357851293.jpeg');
INSERT INTO `shangpinzhonglei` VALUES (48, '2024-03-25 17:11:00', '类型10', 'upload/1711357859410.jpeg');
...
-- Records of storeup
-- ----------------------------
INSERT INTO `storeup` VALUES (1, '2024-03-25 18:47:47', 1711357906369, 57, 'shangpinxinxi', '汽车2', 'upload/1711358650564.jpeg', '1', NULL, NULL);
...
-- Records of token
-- ----------------------------
INSERT INTO `token` VALUES (1, 11, '用户账号1', 'yonghu', '用户', 'y4w8jyoxypxng8g250vhmgzbi70nccyj', '2024-03-25 13:48:32', '2024-03-25 14:48:32');
INSERT INTO `token` VALUES (2, 1, 'admin', 'users', '管理员', '4in166u6eyzyvwx4jb0gk8kttj2oy8zg', '2024-03-25 13:53:28', '2026-03-29 17:31:04');
INSERT INTO `token` VALUES (3, 28, '商家号8', 'shangjia', '商家', '11dwth9e8l93ah6ktexvcbhrkmgdgle1', '2024-03-25 17:11:17', '2024-03-25 19:43:27');
INSERT INTO `token` VALUES (4, 1711357906369, '123', 'yonghu', '用户', 'bhmg7nzadrsoeawnvn8ym774st88oydy', '2024-03-25 17:11:49', '2024-03-25 19:48:49');
INSERT INTO `token` VALUES (5, 27, '商家号7', 'shangjia', '商家', '5bndzibper9rk06o5mrcxrniw0wfcrha', '2024-03-25 17:13:29', '2024-03-25 18:13:29');
INSERT INTO `token` VALUES (6, 26, '商家号6', 'shangjia', '商家', '5piibh535f6n667az6zweg37977xcr4m', '2024-03-25 17:15:45', '2024-03-25 19:46:43');
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (1, 'admin', 'admin', 'upload/image1.jpg', '管理员', '2024-03-25 13:38:01');
...
) ENGINE = InnoDB AUTO_INCREMENT = 1711357906370 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '用户' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of yonghu
-- ----------------------------
INSERT INTO `yonghu` VALUES (11, '2024-03-25 13:38:01', '用户账号1', '123456', '用户姓名1', '男', 1, 'upload/yonghu_touxiang1.jpg', 200);
INSERT INTO `yonghu` VALUES (12, '2024-03-25 13:38:01', '用户账号2', '123456', '用户姓名2', '男', 2, 'upload/yonghu_touxiang2.jpg', 200);
INSERT INTO `yonghu` VALUES (13, '2024-03-25 13:38:01', '用户账号3', '123456', '用户姓名3', '男', 3, 'upload/yonghu_touxiang3.jpg', 200);
INSERT INTO `yonghu` VALUES (14, '2024-03-25 13:38:01', '用户账号4', '123456', '用户姓名4', '男', 4, 'upload/yonghu_touxiang4.jpg', 200);
INSERT INTO `yonghu` VALUES (15, '2024-03-25 13:38:01', '用户账号5', '123456', '用户姓名5', '男', 5, 'upload/yonghu_touxiang5.jpg', 200);
INSERT INTO `yonghu` VALUES (16, '2024-03-25 13:38:01', '用户账号6', '123456', '用户姓名6', '男', 6, 'upload/yonghu_touxiang6.jpg', 200);
INSERT INTO `yonghu` VALUES (17, '2024-03-25 13:38:01', '用户账号7', '123456', '用户姓名7', '男', 7, 'upload/yonghu_touxiang7.jpg', 200);
INSERT INTO `yonghu` VALUES (18, '2024-03-25 13:38:01', '用户账号8', '123456', '用户姓名8', '男', 8, 'upload/yonghu_touxiang8.jpg', 200);
INSERT INTO `yonghu` VALUES (1711357906369, '2024-03-25 17:11:46', '123', '123', 'aaa', '男', 12, 'upload/1711357916574.jpg', 2966667);
